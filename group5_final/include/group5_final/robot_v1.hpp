...
private:
    ...
    //bool FloorRobotPickAGVTrayPart(ariac_msgs::msg::Part part_to_pick, std::vector<ariac_msgs::msg::PartPose> agv_parts, geometry_msgs::msg::Pose, int agv_num);
   ...
   // Quality Check Functions
    ...
    std::map<std::string, bool> agv_availability = {
        {"1", false},
        {"2", false},
        {"3", false},
        {"4", false},
    ...
    std::map<std::string, double> left_disposal_bin_js = {
        {"linear_actuator_joint", 4.05},
        {"floor_shoulder_pan_joint", 2.129},
        {"floor_shoulder_lift_joint", -1.186},
        {"floor_elbow_joint", 1.047},
        {"floor_wrist_1_joint", -1.466},
        {"floor_wrist_2_joint", -1.571},
        {"floor_wrist_3_joint", 0.017}
    };
